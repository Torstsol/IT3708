...
optimalFolder = "Evaluator/Optimal_Segmentation_Files" # you may have to specify the complete path
studentFolder = "Evaluator/Student_Segmentation_Files" # you may have to specify the complete path
